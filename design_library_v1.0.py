    ...
    for line in input:
        ...
        if left<0:
            ...
            if usef==0:
                ...
                if left<0:
                    left=0
        rawregion=line[0]+":"+line[1]+"-"+line[2]
...
def tiling_mutated(fastafile,output,only_middle,tiling_mutation):
    ...
    for line in input:
        ...
        if peaklen <= 0:
            ...
            out1.write(line[0]+":::"+"W"+":::"+seq2+'\t'+line[1]+"\n")
            out1.write(line[0]+":::"+"M"+":::"+seq2+'\t'+seq1+seq3+"\n")
       # else :
...
if __name__=="__main__":
    opts, args=getopt.getopt(sys.argv[1:], "hi:o:g:l:s:f:me:tka:b:", ["help","fasta=","enzyme=","tiling","binsize=","sublength=","mutation=","tiling_mutation=","only_middle"])
    length=0
    fp=0.0
    extendto=0
    title=0
